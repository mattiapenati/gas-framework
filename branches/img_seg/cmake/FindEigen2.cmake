...
IF(EIGEN_INCLUDE_DIRS)
  ...
  MESSAGE(STATUS "Found Eigen 2: ${EIGEN_INCLUDE_DIRS}")
ELSE(EIGEN_INCLUDE_DIRS)
  MESSAGE(FATAL_ERROR "Eigen 2 not found - Please install Eigen 2")
...
ELSE(UMFPACK_INCLUDE_DIRS)
  MESSAGE(FATAL_ERROR "UMFPACK not found - Please install UMFPACK")
